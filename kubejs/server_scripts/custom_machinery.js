onEvent('recipes', e => {
  ...
  function focusEntangled(inputbox, outputblock) {
    e.custom({
      "type": "custommachinery:custom_machine", "machine": "ragnamod_7:focus_entangled", "time": 20, "requirements": [{ "type": "custommachinery:item", "mode": "input", "slot": "input_focus_entangled1", "item": "ragnamod_seven:unknown_ingot_block", "amount": 1 }, { "type": "custommachinery:item", "mode": "input", "slot": "input_focus_entangled2", "item": "ragnamod_seven:unknown_ingot_block", "amount": 1 }, { "type": "custommachinery:item", "mode": "input", "slot": "input_focus_entangled3", "item": "ragnamod_seven:unknown_ingot_block", "amount": 1 }, { "type": "custommachinery:item", "mode": "input", "slot": "input_focus_entangled4", "item": "ragnamod_seven:unknown_ingot_block", "amount": 1 }, { "type": "custommachinery:item", "mode": "input", "slot": "input_focus_entangled_focus", "item": "ars_nouveau:summon_focus", "amount": 1, "chance": 0.0 }, { "type": "custommachinery:item", "mode": "input", "slot": "input_focus_entangled_box", "item": "evilcraft:box_of_eternal_closure", "nbt": "{spiritTag:{innerEntity:\"" + inputbox + "\"}}", "amount": 1, "chance": 0.0 }, { "type": "custommachinery:energy", "mode": "input", "amount": 1000000 }, { "type": "custommachinery:item", "mode": "output", "slot": "output_focus_entangled", "item": outputblock, "amount": 4 }, { "type": "custommachinery:structure", "pattern": [["     ", "     ", "  A  ", "   C ", "     "], ["     ", "  A  ", " ABAC", "  AC ", "  C  "], ["     ", "  AC ", " ABA ", " Cm  ", "     "], ["  C  ", " CA  ", "CABA ", "  A  ", "     "], ["     ", " C   ", "  A  ", "     ", "     "]], "keys": { "A": "gemsnjewels:kunzite_block", "B": "ars_nouveau:source_gem_block", "C": "forbidden_arcanus:arcane_golden_glass" } }]
    })
  }
  ...
  //Simulation Matrix
  function simulMatrix(output, pedestal) { e.custom({ "type": "custommachinery:custom_machine", "machine": "ragnamod_7:simulation_matrix", "time": 20, "error": false, "requirements": [{ "type": "custommachinery:energy", "mode": "input", "amount": 10000 }, { "type": "custommachinery:item", "mode": "output", "item": "hostilenetworks:prediction", "nbt": "{data_model:{id:\"hostilenetworks:" + output + "\"}}", "amount": 2 }, { "type": "custommachinery:block", "mode": "output", "action": "check", "pos": [0, 0, 0, 0, 1, 0], "whitelist": true, "filter": ["spirit:pedestal{item:{Count:1b,id:'hostilenetworks:" + pedestal + "_complete_prediction'}}"] }, { "type": "custommachinery:structure", "pattern": [[" C ", "CmC"], [" A ", "BDB"]], "keys": { "A": "architects_palette:lit_withered_osseous_skull", "B": "decorative_blocks:soul_brazier", "C": "create:scorchia_pillar", "D": "spirit:pedestal" } }] }) }
  ...
  simulMatrix("cataclysm/ignis", 'ignis')
  simulMatrix("cataclysm/nether_monstrosity", 'nether_monstrosity')
  simulMatrix("cataclysm/ender_guardian", 'ender_guardian')
  ...
  singCata('hydraulicengine', 'steamengine', 'heatengine', 'precisionmechanism', 'shadow_radiance', 'create')
  ...
  //PSI Stabilizer
  function psiStab(item) { e.custom({ "type": "custommachinery:custom_machine", "machine": "ragnamod_7:psi_stabilizer", "time": 10, "error": false, "requirements": [{ "type": "custommachinery:energy", "mode": "input", "amount": 10000 }, { "type": "custommachinery:item", "mode": "input", "slot": "input", "item": item, "amount": 1, "chance": 0 }, { "type": "custommachinery:item", "mode": "output", "item": item, "amount": 1, "slot": "output" }, { "type": "custommachinery:structure", "pattern": [["m"], ["A"], ["B"], ["C"]], "keys": { "A": "psi:cad_assembler", "B": "ragnamod_seven:psi_stabilizer", "C": "psi:psigem_block", } }] }) }
  psiStab("psi:psidust")
  ...
  e.custom({
    ...
    "requirements": [
      ...
      { "type": "custommachinery:item", "mode": "output", "item": "ragnamod_seven:sphere", "amount": 1 },
      {
        "type": "custommachinery:structure",
        "pattern": [
          [
  ...
  advEphae('ragnamod_seven:infinity_nugget', 'gemsnjewels:garnet', 'miningmaster:spirit_garnet', 'gemsnjewels:spinel', 'redstone_arsenal:flux_gem', 'blue_skies:pyrope_gem', 'gemsnjewels:tourmaline', 'ragnamod_seven:red_gem', 1, 25, 1)
  advEphae('ragnamod_seven:infinity_nugget', 'tinkers_reforged:hureaulite_gem', 'miningmaster:kinetic_opal', 'miningmaster:lucky_citrine', 'gemsnjewels:topaz', 'gemsnjewels:citrine', 'miningmaster:power_pyrite', 'ragnamod_seven:yellow_gem', 1, 25, 1)
  advEphae('ragnamod_seven:infinity_nugget', 'gemsnjewels:emerald', 'ars_nouveau:experience_gem', 'gemsnjewels:peridot', 'blue_skies:diopside_gem', 'minecraft:emerald', 'miningmaster:divine_beryl', 'ragnamod_seven:green_gem', 1, 25, 1)
  advEphae('ragnamod_seven:infinity_nugget', 'byg:subzero_crystal_shard', 'blue_skies:moonstone', 'ae2:certus_quartz_crystal', 'gemsnjewels:aquamarine', 'occultism:soul_gem', 'botania:mana_diamond', 'ragnamod_seven:cyan_gem', 1, 25, 1)
  advEphae('ragnamod_seven:infinity_nugget', 'miningmaster:unbreaking_iolite', 'gemsnjewels:tanzanite', 'miningmaster:dive_aquamarine', 'gemsnjewels:alexandrite', 'gemsnjewels:zircon', 'miningmaster:ice_sapphire', 'ragnamod_seven:blue_gem', 1, 25, 1)
  advEphae('ragnamod_seven:infinity_nugget', 'gemsnjewels:amethyst', 'create:rose_quartz', 'gemsnjewels:morganite', 'gemsnjewels:kunzite', 'miningmaster:heart_rhodonite', 'botania:dragonstone', 'ragnamod_seven:purple_gem', 1, 25, 1)
  advEphae('ragnamod_seven:infinity_nugget', 'miningmaster:spider_kunzite', 'psi:psigem', 'mekanism:fluorite_gem', 'forbidden_arcanus:arcane_crystal', 'gemsnjewels:opal', 'gemsnjewels:pale_diamond', 'ragnamod_seven:white_gem', 1, 25, 1)
  ...
  //FTP Machines
  function FTP(machine, input1, input2, input3, input4, input5, input6, input7, input8, output, curundum, caelestis, elevator, block) {
    e.custom({
      "type": "custommachinery:custom_machine",
      "machine": "ragnamod_7:" + machine + "_machine",
      "time": 200,
      "requirements": [
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_0", "item": "ragnamod_seven:vivid_opinium_core", "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_1", "item": input1, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_2", "item": input2, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_3", "item": input3, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_4", "item": input4, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_5", "item": input5, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_6", "item": input6, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_7", "item": input7, "amount": 1 },
        { "type": "custommachinery:item", "mode": "input", "slot": machine + "_input_8", "item": input8, "amount": 1 },
        { "type": "custommachinery:item", "mode": "output", "item": output, "amount": 1 },
        { "type": "custommachinery:energy", "mode": "input", "amount": 1000000 },
        { "type": "custommachinery:dimension", "filter": "beyond_earth:glacio_orbit" },
        {
          "type": "custommachinery:structure",
          "pattern": [
            [
            ...
            [
              ...
              "  e      e                 eeadddaee                 e      e  ",
              "  e      e                eaabdddbaae                e      e  ",
              "  e      e               eabbefgfebbae               e      e  ",
              " e       e              eab  efgfe  bae              e       e ",
              " e      de             eab   efgfe   bae             ed      e ",
              " e      de             eab   efgfe   bae             ed      e ",
              " e      ddeeeeeeeeeeeeeabeeeeehiheeeeebaeeeeeeeeeeeeedd      e ",
              " e      dddddddddddddddddffffhhihhffffddddddddddddddddd      e ",
              " e      dddddddddddddddddggggiimiiggggddddddddddddddddd      e ",
              " e      dddddddddddddddddffffhhihhffffddddddddddddddddd      e ",
              " e      ddeeeeeeeeeeeeeabeeeeehiheeeeebaeeeeeeeeeeeeedd      e ",
              " e      de             eab   efgfe   bae             ed      e ",
              " e      de             eab   efgfe   bae             ed      e ",
            ...
            [
              ...
              "          dd     aaa                       aaa     dd          ",
              "         dd    aaa         dd     dd         aaa    dd         ",
              "        dd    aaa      dddd  d   d  dddd      aaa    dd        ",
              "       dd    aaa     ddd     d   d     ddd     aaa    dd       ",
              "       d    aa     dd        d   d        dd     aa    d       ",
              "      d    aa     dd         d   d         dd     aa    d      ",
              "     d    aa     d           d   d           d     aa    d     ",
              "    dd   aaa   dd            d   d            dd   aaa   dd    ",
              "    d    aa    d             d   d             d    aa    d    ",
              "   d    aa    d              d   d              d    aa    d   ",
              "   d   aa    d               d   d               d    aa   d   ",
              "  dd   aa   dd               d   d               dd   aa   dd  ",
              "  d   aa    d                d   d                d    aa   d  ",
              "  d   aa   d                 d   d                 d   aa   d  ",
              " d    aa   d                 d   d                 d   aa    d ",
              " d   aa   dd               ddb   bdd               dd   aa   d ",
              " d   aa   d               dbb     bbd               d   aa   d ",
              " d   aa   d              db         bd              d   aa   d ",
              "d   aa    d             db           bd             d    aa   d",
              "d   aa   d             db             bd             d   aa   d",
              "d   aa   d             db             bd             d   aa   d",
              "d   aa    dddddddddddddb               bddddddddddddd    aa   d",
              "d   aa                                                   aa   d",
              "d   aa                                                   aa   d",
              "d   aa                                                   aa   d",
              "d   aa    dddddddddddddb               bddddddddddddd    aa   d",
            ...
            [
              ...
              "                   aaa                   aaa                   ",
              "                 aa       aaaaaaaaaaa       aa                 ",
              "               aa     aaaajjjjjjjjjjjaaaa     aa               ",
              "              a     aaajjjjjjjjjjjjjjjjjaaa     a              ",
              "             a    aajjjjjjaaaaaaaaaaajjjjjjaa    a             ",
              "           aa   aajjjjjaaaa         aaaajjjjjaa   aa           ",
              "          a    aajjjaaa                 aaajjjaa    a          ",
              "         a    ajjjaaa      aa     aa      aaajjja    a         ",
              "        a   aajjjaa     aaa  a   a  aaa     aajjjaa   a        ",
              "       a   aajjja    aaa     a   a     aaa    ajjjaa   a       ",
              "       a  aajjaa    a        a   a        a    aajjaa  a       ",
              "      a   ajjaa   aa         a   a         aa   aajja   a      ",
              "     a   ajjaa   a           a   a           a   aajja   a     ",
              "    a   ajjja   a            a   a            a   ajjja   a    ",
              "    a  aajja   a             a   a             a   ajjaa  a    ",
              "   a   ajja   a              a   a              a   ajja   a   ",
              "   a  ajjaa  a               a   a               a  aajja  a   ",
              "  a   ajja   a               a   a               a   ajja   a  ",
              "  a  ajjaa  a                a   a                a  aajja  a  ",
              "  a  ajja  a                 a   a                 a  ajja  a  ",
              " a  aajja  a                 a   a                 a  ajjaa  a ",
              " a  ajja   a               aab   baa               a   ajja  a ",
              " a  ajja  a               abb     bba               a  ajja  a ",
              " a  ajja  a              ab         ba              a  ajja  a ",
              "a  ajjaa  a             ab           ba             a  aajja  a",
              "a  ajja  a             ab             ba             a  ajja  a",
              "a  ajja  a             ab             ba             a  ajja  a",
              "a  ajja   aaaaaaaaaaaaab               baaaaaaaaaaaaa   ajja  a",
              "a  ajja                                                 ajja  a",
              "a  ajja                                                 ajja  a",
              "a  ajja                                                 ajja  a",
              "a  ajja   aaaaaaaaaaaaab               baaaaaaaaaaaaa   ajja  a",
            ...
            [
              ...
              " e      de             eab           bae             ed      e ",
              " e      de             eab           bae             ed      e ",
              " e      ddeeeeeeeeeeeeeab             baeeeeeeeeeeeeedd      e ",
              " e      ddddddddddddddddb             bdddddddddddddddd      e ",
              " e      ddddddddddddddddb             bdddddddddddddddd      e ",
              " e      ddddddddddddddddb             bdddddddddddddddd      e ",
              " e      ddeeeeeeeeeeeeeab             baeeeeeeeeeeeeedd      e ",
              " e      de             eab           bae             ed      e ",
          ...
          "keys": {
            ...
            "b": caelestis,
            "c": elevator,
            "d": "beyond_earth:iron_plating_block",
            "e": "architects_palette:hazard_block",
            "f": "createcasing:creative_casing",
            "g": "hostilenetworks:machine_frame",
            "h": "ftbic:advanced_machine_block",
            "i": "ragnamod_seven:noisy_neutronium",
            "j": block
          }
        }
      ]
  ...
  FTP('f', 'ragnamod_seven:blue_gem', 'ragnamod_seven:blue_antimatter_pellet', 'bloodmagic:waterritualstone', 'chemlib:vanadium_metal_block', 'quark:blue_rune', 'vtones:azur_block_9', 'ars_elemental:lesser_water_focus', 'malum:aqueous_spirit', 'ragnamod_seven:f', 'quark:indigo_corundum', 'miniutilities:blue_lapis_caelestis', 'elevatorid:elevator_blue', 'miningmaster:ice_sapphire_block')
  FTP('t', 'ragnamod_seven:green_gem', 'ragnamod_seven:green_antimatter_pellet', 'bloodmagic:earthritualstone', 'chemlib:praseodymium_metal_block', 'quark:green_rune', 'vtones:sync_block_12', 'ars_elemental:lesser_earth_focus', 'malum:earthen_spirit', 'ragnamod_seven:t', 'quark:green_corundum', 'miniutilities:green_lapis_caelestis', 'elevatorid:elevator_green', 'miningmaster:haste_peridot_block')
  FTP('p', 'ragnamod_seven:red_gem', 'ragnamod_seven:red_antimatter_pellet', 'bloodmagic:fireritualstone', 'chemlib:lutetium_metal_block', 'quark:red_rune', 'vtones:reds_block_4', 'ars_elemental:lesser_fire_focus', 'malum:sacred_spirit', 'ragnamod_seven:p', 'quark:red_corundum', 'miniutilities:red_lapis_caelestis', 'elevatorid:elevator_red', 'miningmaster:fire_ruby_block')

  //F Machine
  e.shaped(Item.of('custommachinery:custom_machine_item', '{machine:"ragnamod_7:f_machine"}'), ['ABA', 'BCD', 'ABA'], { A: 'ftbic:iridium_circuit', B: 'miniutilities:blue_lapis_caelestis', C: 'xnet:controller', D: 'rftoolsutility:screen' })

  //T Machine
  e.shaped(Item.of('custommachinery:custom_machine_item', '{machine:"ragnamod_7:t_machine"}'), ['ABA', 'BCD', 'ABA'], { A: 'ftbic:iridium_circuit', B: 'miniutilities:green_lapis_caelestis', C: 'xnet:controller', D: 'rftoolsutility:screen' })

  //P Machine
  e.shaped(Item.of('custommachinery:custom_machine_item', '{machine:"ragnamod_7:p_machine"}'), ['ABA', 'BCD', 'ABA'], { A: 'ftbic:iridium_circuit', B: 'miniutilities:red_lapis_caelestis', C: 'xnet:controller', D: 'rftoolsutility:screen' })

  //tiny Agglomerate
  function tinyAgglo(agglo) {
    e.custom({
      "type": "custommachinery:custom_machine",
      "machine": "ragnamod_7:agglomeration_splitter",
      "time": 60,
      "requirements": [
        { "type": "custommachinery:item", "mode": "input", "slot": "agglomeration_splitter_input", "item": "ragnamod_seven:agglomerate_matter_" + agglo, "amount": 1 },
        { "type": "custommachinery:item", "mode": "output", "item": "ragnamod_seven:tiny_agglomerate_matter_" + agglo, "amount": 2 },
        { "type": "custommachinery:energy", "mode": "input", "amount": 1000000 },
        { "type": "custommachinery:dimension", "filter": "ae2:spatial_storage" },
        {
        ...
        },
        {
          ...
          "keys": {
            "a": "architects_palette:hadaline_lamp[axis\u003dz,charge_source\u003dnorth,charged\u003dfalse]",
            "b": "architects_palette:hadaline_lamp[axis\u003dx,charge_source\u003dnorth,charged\u003dfalse]",
            "c": "entangled:block",
            "d": "draconicevolution:reactor_injector",
            "e": "architects_palette:hadaline_lamp[axis\u003dy,charge_source\u003dnorth,charged\u003dfalse]",
  ...
  var name = ["minecraft1", "minecraft2", "minecraft3", "twilight", "blood_magic", "create", "mekanism", "powah", "botania", "blue_skies", "space", "blocky", "mobs", "psi", "thermal", "evil_craft", "ae2", "forbidden_arcanus", "undergarden", "ftbic", "tconstruct", "ars", "pneumaticcraft", "tech"]
  name.forEach(N => { tinyAgglo(N) })
