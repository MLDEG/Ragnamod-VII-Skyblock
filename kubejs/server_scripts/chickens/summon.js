...
onEvent('recipes', e => {
    ...
    summonChicken('mysticalagriculture:inferium_block', 'mysticalagriculture:inferium_gemstone', 'inferium')
    summonChicken('mysticalagriculture:prudentium_block', 'mysticalagriculture:prudentium_gemstone', 'prudentium')
    summonChicken('mysticalagriculture:tertium_block', 'mysticalagriculture:tertium_gemstone', 'tertium')
    ...
    summonChicken('ragnamod_seven:compressed_soul_steel_block', 'ragnamod_seven:compressed_soul_steel_block', 'juju80233')
