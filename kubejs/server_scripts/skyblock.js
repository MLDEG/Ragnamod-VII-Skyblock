onEvent('recipes', e => {
    ...
    agglomerateReconstitution('ragnamod_seven:tiny_agglomerate_matter_create', 'create_sa:hydraulic_engine', 'create_sa:steam_engine', 'create_sa:heat_engine', 'create:electron_tube', 'create:precision_mechanism', 'ragnamod_seven:agglomerate_matter_create')
