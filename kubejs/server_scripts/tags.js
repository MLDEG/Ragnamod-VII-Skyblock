onEvent('tags.items', e => {
    ...
    //Remove Other
    e.remove('tombstone:seeds', ['#forge:seeds', 'minecraft:cocoa_beans', 'twilightforest:magic_beans'])
    ...
    function botanyPotsBasic(botanycolor) {
        ...
        e.add('botanypots:basic_botany_pot', ['botanypots:terracotta_botany_pot', 'botanypots:' + botanycolor + '_glazed_terracotta_botany_pot', 'botanypots:' + botanycolor + '_concrete_botany_pot', 'botanypots:' + botanycolor + '_terracotta_botany_pot'])
        e.add('botanypotstiers:elite_botany_pot', ['botanypotstiers:elite_terracotta_botany_pot', 'botanypotstiers:elite_' + botanycolor + '_glazed_terracotta_botany_pot', 'botanypotstiers:elite_' + botanycolor + '_concrete_botany_pot', 'botanypotstiers:elite_' + botanycolor + '_terracotta_botany_pot'])
        e.add('botanypotstiers:ultra_botany_pot', ['botanypotstiers:ultra_terracotta_botany_pot', 'botanypotstiers:ultra_' + botanycolor + '_glazed_terracotta_botany_pot', 'botanypotstiers:ultra_' + botanycolor + '_concrete_botany_pot', 'botanypotstiers:ultra_' + botanycolor + '_terracotta_botany_pot'])
        e.add('botanypotstiers:creative_botany_pot', ['botanypotstiers:creative_terracotta_botany_pot', 'botanypotstiers:creative_' + botanycolor + '_glazed_terracotta_botany_pot', 'botanypotstiers:creative_' + botanycolor + '_concrete_botany_pot', 'botanypotstiers:creative_' + botanycolor + '_terracotta_botany_pot'])
    }
    ...
    e.add('create:upright_on_belt', ['ragnamod_seven:cake_mold', 'ragnamod_seven:cake_mold_filled', 'ragnamod_seven:cake_mold_baked', 'tconstruct:ender_cake', 'tconstruct:earth_cake', 'tconstruct:sky_cake', 'tconstruct:blood_cake', 'tconstruct:magma_cake', 'telepastries:nether_cake', 'telepastries:end_cake', 'telepastries:overworld_cake', 'telepastries:twilight_cake', 'ragnamod_seven:ender_cake_mold_baked', 'ragnamod_seven:earth_cake_mold_baked', 'ragnamod_seven:sky_cake_mold_baked', 'ragnamod_seven:blood_cake_mold_baked', 'ragnamod_seven:magma_cake_mold_baked', 'ragnamod_seven:nether_cake_mold_baked', 'ragnamod_seven:end_cake_mold_baked', 'ragnamod_seven:overworld_cake_mold_baked', 'ragnamod_seven:twilight_cake_mold_baked', 'ragnamod_seven:undergarden_cake_mold_baked', 'ragnamod_seven:ender_cake_base_baked', 'ragnamod_seven:earth_cake_base_baked', 'ragnamod_seven:sky_cake_base_baked', 'ragnamod_seven:blood_cake_base_baked', 'ragnamod_seven:magma_cake_base_baked', 'ragnamod_seven:nether_cake_base_baked', 'ragnamod_seven:end_cake_base_baked', 'ragnamod_seven:overworld_cake_base_baked', 'ragnamod_seven:twilight_cake_base_baked', 'ragnamod_seven:undergarden_cake_base_baked', 'telepastries:custom_cake', 'ragnamod_seven:sky_cake_mold_filled', 'ragnamod_seven:blood_cake_mold_filled', 'ragnamod_seven:magma_cake_mold_filled', 'ragnamod_seven:nether_cake_mold_filled', 'ragnamod_seven:end_cake_mold_filled', 'ragnamod_seven:overworld_cake_mold_filled', 'ragnamod_seven:twilight_cake_mold_filled', 'ragnamod_seven:undergarden_cake_mold_filled', 'ragnamod_seven:ender_cake_mold_filled', 'ragnamod_seven:earth_cake_mold_filled', 'telepastries:custom_cake2'])
    e.add('ragnamod_seven:tiny_agglomerate', [/ragnamod_seven:tiny/])

    e.add("forge:seeds", ['mysticalagriculture:dark_gem_seeds', 'mysticalagriculture:cyber_steel_seeds', 'mysticalagriculture:crusteel_seeds', 'mysticalagriculture:cloggrum_seeds', 'mysticalagriculture:cinnabar_seeds', 'mysticalagriculture:chorus_metal_seeds', 'mysticalagriculture:blazing_copper_seeds', 'mysticalagriculture:baolian_seeds', 'mysticalagriculture:aquite_seeds', 'mysticalagriculture:sculk_seeds', 'mysticalagriculture:red_beryl_seeds', 'mysticalagriculture:qivium_seeds', 'mysticalagriculture:pyrope_seeds', 'mysticalagriculture:plastic_seeds', 'mysticalagriculture:piroot_seeds', 'mysticalagriculture:magma_steel_seeds', 'mysticalagriculture:lavium_seeds', 'mysticalagriculture:kepu_seeds', 'mysticalagriculture:hureaulite_seeds', 'mysticalagriculture:horizonite_seeds', 'mysticalagriculture:gelot_seeds', 'mysticalagriculture:gausum_seeds', 'mysticalagriculture:galu_seeds', 'mysticalagriculture:froststeel_seeds', 'mysticalagriculture:forgotten_seeds', 'mysticalagriculture:flux_infused_seeds', 'mysticalagriculture:felsteel_seeds', 'mysticalagriculture:falsite_seeds', 'mysticalagriculture:fairy_seeds', 'mysticalagriculture:epidote_seeds', 'mysticalagriculture:energy_crystal_seeds', 'mysticalagriculture:emeraldite_seeds', 'mysticalagriculture:electrical_copper_seeds', 'mysticalagriculture:durasteel_seeds', 'mysticalagriculture:duralium_seeds', 'mysticalagriculture:dragonsteel_seeds', 'mysticalagriculture:yokel_seeds', 'mysticalagriculture:wavy_seeds', 'mysticalagriculture:ventium_seeds', 'mysticalagriculture:source_gem_seeds', 'mysticalagriculture:regalium_seeds', 'mysticalagriculture:pendorite_seeds', 'mysticalagriculture:ostrum_seeds', 'mysticalagriculture:diopside_seeds', 'mysticalagriculture:desh_seeds', 'mysticalagriculture:calorite_seeds', 'mysticalagriculture:arcane_gold_seeds', 'mysticalagriculture:arcane_crystal_seeds', 'mysticalagriculture:ametrine_seeds', 'mysticalagriculture:twinite_seeds', 'mysticalagriculture:soul_infused_seeds', 'mysticalagriculture:shellite_seeds', 'mysticalagriculture:rune_seeds', 'mysticalagriculture:utheric_seeds', 'mysticalagriculture:iesnium_seeds', 'mysticalagriculture:demonite_seeds', 'mysticalagriculture:decay_seeds', 'mysticalagriculture:charoite_seeds', 'mysticalagriculture:infinity_seeds', 'mysticalagriculture:chaotic_seeds', 'mysticalagriculture:antimatter_seeds', 'mysticalagriculture:alfsteel_seeds'])

    e.add('create:cogwheels', ['createcasing:warped_cogwheel', 'createcasing:crimson_cogwheel', 'createcasing:dark_oak_cogwheel', 'createcasing:acacia_cogwheel', 'createcasing:jungle_cogwheel', 'createcasing:birch_cogwheel', 'createcasing:oak_cogwheel', 'create:cogwheel'])

    e.remove('matc:inferium', 'mysticalagriculture:master_infusion_crystal')
    e.remove('matc:prudentium', 'mysticalagriculture:master_infusion_crystal')
    e.remove('matc:tertium', 'mysticalagriculture:master_infusion_crystal')
    e.remove('matc:imperium', 'mysticalagriculture:master_infusion_crystal')
    e.remove('matc:supremium', 'mysticalagriculture:master_infusion_crystal')
    e.remove('mysticalagriculture:infusion_crystals', 'mysticalagriculture:master_infusion_crystal')
})
